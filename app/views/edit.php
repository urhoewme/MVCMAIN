        ...
        <div class="col-md-12">
            <div class="card mt-4">
                <div class="card-header">
                    <h4>Customer Edit
                        <a href="/users" class="btn btn-danger float-end">BACK</a>
                    </h4>
                </div>
                <div class="card-body">
                    <form action="" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="status" >
                                <option value="active" name="active" <?php echo $params->gender==="active"?"selected":""?>>Active</option>
                                <option value="inactive" name="inactive" <?php echo $params->gender==="inactive"?"selected":""?>>Inactive</option>
                            </select>
